    ...
    return (
        ...
        <img src={logo} alt="Logo" />
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/includePrince" target="_blank">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/prince-kumar-644128284/" target="_blank">
...
<p>LinkedIn</p>
                ...
                <a className="twitter" href="https://x.com/i_d_prince" target="_blank">
...
<p>Twitter</p>
                ...
                <a className="schedule" href="" target="_blank">
...
<p>Telegram</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-two"><NavLink className="nav-link" onClick={check} to="/projects">Projects</NavLink></li>
                        ...
                        <li className="menu-five"><a className="nav-link" href="mailto:prince.kr9835660@gmail.com" target="_blank">Contact</a></li>
                    </ul>
                    </div>    
            </div>
            </div>
